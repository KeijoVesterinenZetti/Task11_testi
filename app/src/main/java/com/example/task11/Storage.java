...
public class Storage {
    ...
    public void saveFoods(Context context) {
        try {
            ObjectOutputStream userWriter = new ObjectOutputStream(context.openFileOutput("foods.data", Context.MODE_APPEND));
    ...
    public void loadFoods(Context context) {
        try {
            ObjectInputStream userReader = new ObjectInputStream(context.openFileInput("foods.data"));
